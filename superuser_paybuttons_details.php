...
<div class="media-list hero"><img src="img/wave.png" ></div>
...
<div id="rcorners_flat">
				  ...
				  <div class="media container">
				    ...
				    <div class="media-body">
				      <h4 class="media-heading" style="border-bottom: 1px #8f8989 solid;"><strong><?php echo userValueSuper($superuser_id,$superuser,"username") ?></strong></h4><br>
				       <h5><i><font color=black>Bestelpagina '<?php echo $row_button['title'] ?>'.</font></i></h5>
				      </div>
				  </div>
				</div>
			<?php if($row_button['picture'] <> ""){ ?>
    <div id="idpicture" class="media-picture" align="center">
        <img width="100%" src="/data/<?php echo $superuser ?>s_webshop/<?php echo $superuser_id ?>/<?php echo $row_button['picture'] ?>" style="border-radius: 5px; margin-bottom: 10px">
    </div>
    <?php } else { ?>
...
<div style="background-color: transparent">
			...
			echo "<div class='media-message'>" . $row_button['message'] . "</div>";
?>
			<table width="100%" class="table-calendar">
			<?php
			if($adult_id <> "0"){
					?>
					<tr><td style="vertical-align: middle"><span></span></td><td class="shop-paybutton center"> Je doet deze betaling voor <select class="changebuyer" style="display: inline">
					<?php
			...
			<tr><td class="shop-paybutton center"><span></span></td><td class="shop-paybutton center media-shop-text"><?php echo $row_button['invoice'] ?></td></tr>
			<tr><td><span></span></td><td class="shop-paybutton center colored"><span class="fa fa-shopping-cart fa-fw"></span> Kostprijs: <?php 
			...
			<tr><td class="shop-paybutton gray"><span class="fa fa-calendar fa-fw"></span></td><td class="shop-paybutton gray"> Te betalen voor: <u><?php echo $enddate_format ?></u></td></tr>
...
<div style="color:black; font-size: smaller" align="center">
  Opmerking: Je betaalt voor <?php echo $for ?>
</div>
  <?php } ?>
